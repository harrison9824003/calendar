...
var prepareSlides = function(container,opt) {
	...
	opt.allli.find('>img').each(function(j) {
		...
		if(img.data('href')!=""){
			img.wrap('<a class="slotholder" href="'+img.data('href')+'" title="'+img.attr('alt')+'" tabindex="'+img.data('tabindex')+'" style="position:absolute; top:0px; left:0px; z-index:0;width:100%;height:100%;"></a>');
		}
		else{
